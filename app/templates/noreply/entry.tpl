...
<div class="row">
  <div class="form-group">
    ...
    <div class="col-sm-10">
    <select id="title" class="form-control" name="form[title]">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="email" class="form-control" id="mail" name="form[mail]" placeholder="hoge@hoge.hoge" value="<%if isset($inputValue.mail)%><%$inputValue.mail|escape%><%/if%>">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <textarea id="comment" name="form[comment]" class="form-control" rows="6"><%if isset($inputValue.comment)%><%$inputValue.comment|escape%><%/if%></textarea>
...
<div class="btn-group btn-group-justified" role="group">
  <div class="btn-group" role="group">
    <button type="submit" name="process" value="1" class="btn btn-primary">確認画面へ進む</button>
  </div>
</div>
</form>
